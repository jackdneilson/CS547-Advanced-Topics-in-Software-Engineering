...
if __name__ == '__main__':
    ...
    # Register the expressions defined, create an individual creation function, create a population creation function,
    # and register a compilation function
    toolbox = base.Toolbox()
    toolbox.register("expr", gp.genFull, pset=prim_set, min_=3, max_=17)
